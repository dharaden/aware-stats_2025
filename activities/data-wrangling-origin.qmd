...
We are going to keep practicing the skills we started in the last
session. Before, we were using pre-installed data, but that won't be the
case IRL. When working with your own data, you will want to create a
workflow of cleaning and wrangling your data in a reproducible way.
These steps will likely occur for every new dataset that you work with.
...
You should be able to follow along, but if you want a template Markdown,
download it below.

-   <a href="/files/_lab-rmd/data-wrangling.Rmd" download="data-wrangling.Rmd">Download
    Markdown (.Rmd)</a>
...
#### Download your data ([Materials](../materials.html){target="_blank"})
