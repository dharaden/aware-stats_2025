...
footer:  "[course-website](https://dharaden.github.io/aware_2025/)"
logo: "images/hex.png"
format: 
  revealjs:
    theme: clean.scss
...
Then, create a new Markdown Document that we will use for this activity

Setup the libraries and bring in the data

-   We will use the TIPI data ([Download from here](../materials.html){target="_blank"})
...
![](images/clipboard-3265124470.png){fig-align="center" width="508"}

------------------------------------------------------------------------

**Introducing `janitor`** <https://sfirke.github.io/janitor/index.html>

This function automatically puts column names into snake-case
...
For example, we have the [Ten Item Personality Inventory](https://gosling.psy.utexas.edu/scales-weve-developed/ten-item-personality-measure-tipi/){target="_blank"}
